...
import type { ConnectedChecklist, ChecklistTemplate } from '@/lib/types';
        ...
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)}>
                ...
                <CardFooter className="flex justify-end gap-2">
                    ...
                    <Button variant="outline" onClick={() => router.push(`/dashboard/clients/${parentClientId}`)}>Finish &amp; View Client</Button>
                </CardFooter>
            </form>
        </Form>
    </Card>
...
export default function AddChildAccountPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto">
        <div className="mb-6">
            <h1 className="font-headline text-3xl font-bold">Add Google Ads Account</h1>
            <p className="text-muted-foreground">Configure a new child account for your client.</p>
        </div>
      {clientId && <ChildAccountForm parentClientId={clientId as string} />}
    </div>
  );
}
